...
## v1.5.4 – English feedback updates
English participant-facing copy updated according to IBC2026 Quiz Feedback.


## v1.5.5
- 18+ Hinweis und Teilnahmebedingungen auf die Sprachauswahl verschoben.
- Englische Sprachauswahl: 'Choose your language'.
- Satzförmige Antwortoptionen enden mit Punkt; einzelne Wörter/Begriffe bleiben ohne Punkt.


## v1.5.6
- Sprachspezifische 18+- und Teilnahmehinweise direkt unter dem jeweiligen DE-/EN-Startbutton.
- Auf der Themenauswahl ist der 3-Schritte-Ablauf wieder sichtbar.


## v1.5.7 FINAL
- CGI aus der Fusszeile der Sprachauswahl entfernt.
- Kein Punkt hinter Funktioniert ohne Internet / Works without internet.
